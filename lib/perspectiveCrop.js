...
// A manual fallback for when the auto-detected quad still leaves a sliver
// of background: trims a flat percentage off every edge of an
// already-cropped image. Simple rectangular trim, not another perspective
// warp — the image should already be roughly rectangular by this point.
export async function trimMarginPercent(blob, pct = 0.06) {
